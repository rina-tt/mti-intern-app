...
exports.handler = async (event, context) => {
  ...
  if (!body || !body.userId || !body.timestamp || !body.text1 || !body.text2 || !body.text3) {
  ...
  // リクエストパラメータ
  const { userId, timestamp, text1,  text2, text3} = body;
  ...
  try {
    ...
    response.body = JSON.stringify({ userId, timestamp, text1, text2, text3});
  } catch (e) {
